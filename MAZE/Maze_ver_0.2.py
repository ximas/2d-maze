...
def drawroute(lis,x,y,end):
    for _lis_ in lis:
        pygame.draw.rect(screen,(10,10,10),(((_lis_[0])*100)+300,((_lis_[1])*100)-50,100,100),0)
...
def move(move_key,lis,users):
    drawboard(8,8)
    drawroute([[8,1],[8,2],[8,3],[8,4],[8,5],[7,5],[6,5],[5,5],[5,4],[5,3],[5,2],[4,2],[3,2]
               ,[2,2],[2,3],[2,4],[2,5],[2,6],[2,7],[2,8],[3,8],[4,8],[5,8],[6,8],[7,8],
               [7,7],[8,7],[5,6],[4,5],[6,2],[5,1],[1,6]],8,8,[9,7])
    fin = 0
    if move_key == "I":
